package methodEmbedding.Magic_Trick.S.LYD2140;
...
FileInputStream fis=new FileInputStream("A-small-attempt0 (1).in");//name of input file downloaded with same extension
