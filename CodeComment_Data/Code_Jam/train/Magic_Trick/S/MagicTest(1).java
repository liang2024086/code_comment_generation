package methodEmbedding.Magic_Trick.S.LYD2038;
...
public class MagicTest {
	...
	public static void main(String[] args) {
		try {
			BufferedReader fichier = new BufferedReader(new FileReader("A-small-attempt5.in"));
			BufferedWriter sortie = new BufferedWriter( new FileWriter("./A-small-attempt5.out"));
