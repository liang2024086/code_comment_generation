package methodEmbedding.Speaking_in_Tongues.S.LYD261;
...
class Speak
{
	...
	public static void main(String[] args) throws Exception {
		...
		Scanner sc = new Scanner(new FileReader("A-small-attempt5.in"));
		//Console console=System.console(new FileReader("A-small-practice-1.in"));
		PrintWriter pw = new PrintWriter(new FileWriter("A-small-attempt5.out"));
