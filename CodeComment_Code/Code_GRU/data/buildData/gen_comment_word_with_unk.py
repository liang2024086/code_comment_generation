...
def _read_raw_comments(fileName,repo_name):
    ...
    data_file = open('./comment_words/repo_%s/commentWordMap.txt'%repo_name,'w')
...
if __name__ == '__main__':
    ...
    #repos = ['jna','cocos2d','mockito','guice','jersey','rhino','zxing']
    repos = ['libgdx']
    for repo in repos:
	#_read_raw_comments('/home/yuding/workspace/RepoComment/CommentRNN/gen_vector/repo_%s/comments.txt'%repo,repo)
        _read_raw_comments('/home/yuding/workspace/RepoComment/CommentRNN/gen_vector/repo_%s/methodCommentMap.txt'%repo,repo)
