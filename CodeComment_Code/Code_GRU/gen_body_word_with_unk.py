...
def _read_raw_bodies(fileName):
    ...
    if not os.path.exists('./data/body_words/'):
        os.makedirs('./data/body_words/')
    data_file = open('./data/body_words/bodyWordMap.txt','w')
...
if __name__ == '__main__':
    ...
    _read_raw_bodies('../Code_RNN/comment_data/methodBodyMap.txt')
